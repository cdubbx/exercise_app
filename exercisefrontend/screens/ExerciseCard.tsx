import { View, Text, SafeAreaView, Image, Modal, TouchableOpacity, TextInput } from 'react-native';
...
import { useSavePlannedWorkouts } from '../hooks/exercises';
import { Alert } from 'react-native';



const Exercise: React.FC<ExerciseCardProps> = ({ item }) => {
  const { exercise } = item;
