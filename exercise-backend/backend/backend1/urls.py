...
from .views import ExerciseViewSet, LoginAPIView, RegisterAPIView, UserView, LogoutView, SaveWorkOutView, ValidateTokenView, UserPlannedWorkoutsView, UserSavedWorkoutsView
